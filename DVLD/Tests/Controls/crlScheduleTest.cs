...
namespace DVLD.Tests
{
    ...
    public partial class ctrlScheduleTest : UserControl
    {
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID,int AppointmentID=-1 )
        {
            ...
            //تعديل
            if (clsTest.DoesAttendTestType(_LocalDrivingLicenseApplication.LocalDrivingLicenseApplicationID, _TestTypeID))
            ...
            lblTrial.Text = clsTestAppointment.TotalTrialsPerTest(_LocalDrivingLicenseApplication.LocalDrivingLicenseApplicationID,_TestTypeID).ToString();
        ...
        {
            if (_Mode == enMode.AddNew && clsTestAppointment.IsThereAnActiveScheduledTest(_LocalDrivingLicenseApplicationID, _TestTypeID))
            {
        ...
        private bool _HandlePrviousTestConstraint()
        {
            ...
            switch (TestTypeID)
            {
                ...
                case clsTestType.enTestType.WrittenTest:
                    ...
                    if (!clsTest.DoesPassTestType(_LocalDrivingLicenseApplication.LocalDrivingLicenseApplicationID, clsTestType.enTestType.VisionTest))
                    {
                ...
                case clsTestType.enTestType.StreetTest:
                    ...
                    if (!clsTest.DoesPassTestType(_LocalDrivingLicenseApplication.LocalDrivingLicenseApplicationID, clsTestType.enTestType.WrittenTest))
                    {
