...
namespace DVLD.Tests
{
    public partial class frmListTestAppointments: Form
    {
        ...
        private void btnAddNewAppointment_Click(object sender, EventArgs e)
        {
            ...
            if (clsTestAppointment.IsThereAnActiveScheduledTest(_LocalDrivingLicenseApplicationID,_TestType))
            {
                MessageBox.Show("Person Already has an active appointment for this test, You cannot add new appointment", "Not allowed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            clsTest LastTest = clsTest.GetLastTestApplicationIDAndTestTypeAndLicenseClass(localDrivingLicenseApplication.LicenseClassID,
                                                                                           localDrivingLicenseApplication.ApplicationID, _TestType);
            //////////////////////////////
            if (LastTest == null)
            {
